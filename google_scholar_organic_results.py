...
def organic_results():
    ...
    params = {
        "api_key": os.getenv("API_KEY"), # ключ для аутетификации в SerpApi
        "engine": "google_scholar",
        "q": "marxism and feminism", # поисковый запрос
        "hl": "en", # язык
        "as_ylo": "2017", # c 2017 года
        "as_yhi": "2021", # до 2021 года
        "start": "0" # первая страница
    }

    search = GoogleSearch(params) # извлечение данных происходит здесь
    organic_results_data = [] # временный список, куда сохранять данные, которые потом в CSV
